...
GO(mknodat, iFipuU)
GOM(mkostemp, iFEpi)
GOM(mkostemp64, iFEpi)
GOM(mkostemps, iFEpii)
GOM(mkostemps64, iFEpii)
GOM(mkstemp, iFEp)
GOM(mkstemp64, iFEp)
GOM(mkstemps, iFEpi)
GOM(mkstemps64, iFEpi)
GO(__mktemp, pFp)
GOW(mktemp, pFp)
GO(mktime, lFp)
GO(mlock, iFpL)
...
GO(strerror_r, pFipL)
GOM(strerrorname_np, pFEi)
GOM(strerrordesc_np, pFEi)
#ifdef STATICBUILD
//GO(strfmon, lFpLpV)
//GO(__strfmon_l, 
#else
